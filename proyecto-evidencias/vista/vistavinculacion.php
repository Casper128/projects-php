...
include '../modelo/Vinculacion.php';
include '../control/ControlConexion.php';
include '../control/ControlVinculacion.php';

$id=$_POST['txtIdVinculacion'];
$vin=$_POST['txtVinculacion'];
$bot=$_POST['btn'];

//objeto para listar
$objVinculacion= new Vinculacion("","");
$objControlVinculaciones= new ControlVinculaciones($objVinculacion);
$mat=$objControlVinculaciones->listar();
switch ($bot) {
	case 'Guardar':
		$objVinculacion=new Vinculacion($id,$vin);
		$objControlVinculaciones=new ControlVinculaciones($objVinculacion);
		$objControlVinculaciones->guardar();
		$mat=$objControlVinculaciones->listar();
		break;
	case 'Modificar':
		$objVinculacion=new Vinculacion($id,$vin);
		$objControlVinculaciones=new ControlVinculaciones($objVinculacion);
		$objControlVinculaciones->modificar();
		$mat=$objControlVinculaciones->listar();
		break;	
	case 'Borrar':
		$objVinculacion=new Vinculacion($id,"");
		$objControlVinculaciones=new ControlVinculaciones($objVinculacion);
		$objControlVinculaciones->borrar();
		$mat=$objControlVinculaciones->listar();
		break;
	case 'Consultar':
		$objVinculacion=new Vinculacion($id,"");
		$objControlVinculaciones=new ControlVinculaciones($objVinculacion);
		$objVinculacion=$objControlVinculaciones->consultar();
		$id=$objVinculacion->getId();
		$vin=$objVinculacion->getVinculaciones();
		$mat=$objControlVinculaciones->listar();
		break;
	default:
		// code...
                ...
                <div>
                    <div class='card '>
                        <div class='card-header '>
                            FORMULARIO DE REGISTRO DE VINCULACIONES
                        </div>
                        <div class='card-body'>

                            <form method='post' action='vistavinculacion.php'>
                                    ...
                                    <div class='col'>
                                        ...
                                        <input class='form-control' type='text' name='txtIdVinculacion' value=$id>
                                    </div>
                                    <div class='col'>
                                        <label class='form-label'>Programa</label>
                                        <input class='form-control' type='text' name='txtVinculacion' value=$vin>
                                    </div>
                                </div>
                                    <div class='row' >
